import { ENUM_HOTEL_PRODUCT_PRICING_TYPE } from "@/entities/supplier";

import type { IHotelProductIndividualPricingTab } from "../types";
...
export const PRICING_INDIVIDUAL_TABS_LIST: IHotelProductIndividualPricingTab[] =
	[
		{
			label: "form.pricing.pricing_type.tabs.flat_rate",
			type: ENUM_HOTEL_PRODUCT_PRICING_TYPE.FLAT_RATE,
			priceDetailsList: PRICING_FLAT_RATE_PRICE_DETAILS_LIST
		},
		{
			label: "form.pricing.pricing_type.tabs.per_room",
			type: ENUM_HOTEL_PRODUCT_PRICING_TYPE.PER_ROOM
		},
		{
			label: "form.pricing.pricing_type.tabs.per_person",
			type: ENUM_HOTEL_PRODUCT_PRICING_TYPE.PER_PERSON,
