...
function SelectItem({
	...
	return (
		<SelectPrimitive.Item
			...
			className={cn(
				"cursor-pointer focus:bg-accent focus:text-accent-foreground relative flex w-full items-center rounded py-1.5 ps-8 pe-2 text-sm outline-hidden select-none data-disabled:pointer-events-none data-disabled:opacity-50",
				className
			)}
			{...props}
		>
