...
import { OPERATOR_PAYMENT_METHOD_LABELS } from "@/entities/finance";

import type { TForm } from "../types/form.types";

export const FORM_NEW_PAYMENT_ROUTE_COMMON_LIST = (): TForm[] => [
	{
...
export const FORM_NEW_PAYMENT_ROUTE_SWIFT_LIST: TForm[] = [
	{
...
export const FORM_NEW_PAYMENT_ROUTE_WISE_LIST: TForm[] = [
	{
