import { ENUM_TRAIN_PRODUCT_PRICING_TYPE } from "@/entities/supplier";

import type { ITrainProductIndividualPricingTab } from "../types";
...
export const PRICING_INDIVIDUAL_TABS_LIST: ITrainProductIndividualPricingTab[] =
	[
		{
			label: "form.pricing.pricing_type.tabs.flat_rate",
			type: ENUM_TRAIN_PRODUCT_PRICING_TYPE.FLAT_RATE,
			priceDetailsList: PRICING_FLAT_RATE_PRICE_DETAILS_LIST
		},
		{
			label: "form.pricing.pricing_type.tabs.per_fare",
			type: ENUM_TRAIN_PRODUCT_PRICING_TYPE.PER_FARE
		},
		{
			label: "form.pricing.pricing_type.tabs.per_person",
			type: ENUM_TRAIN_PRODUCT_PRICING_TYPE.PER_PERSON,
