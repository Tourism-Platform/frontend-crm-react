...
export interface ITransportationPerCarPriceRow {
	...
	[ENUM_TRANSPORTATION_PRICE_ROW_FIELD.FEES]: IFeeFormRow[];
...
export interface ITransportationCategoryPriceRow
	...
	[ENUM_TRANSPORTATION_CATEGORY_ROW_FIELD.CATEGORY_ID]: string;
	[ENUM_TRANSPORTATION_CATEGORY_ROW_FIELD.PRICE_ID]?: string;
