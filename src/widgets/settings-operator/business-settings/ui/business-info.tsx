...
import type { TOperatorBusinessSchema } from "@/entities/user";

import { BUSINESS_DATA_LIST } from "../model";

interface IBusinessInfoProps {
	form: UseFormReturn<TOperatorBusinessSchema>;
}

const BusinessInfoBase: FC<IBusinessInfoProps> = ({ form }) => {
...
export const BusinessInfo = withErrorBoundary(BusinessInfoBase);
