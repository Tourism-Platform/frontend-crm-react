...
const PricingBase: FC<ISlotProps> = ({ form, onSubmit, isLoading }) => {
	...
	const invoicing = useWatch({
		...
		name: `${ENUM_FORM_SECTION.PRICING}.${ENUM_SUPPLEMENT_PRICING_FIELD.INVOICING}`
	});
		...
		<div className="grid gap-6">
			...
			<div className="grid gap-1">
				...
				<CustomOptionTabs
					...
					onValueChange={(val) =>
						form.setValue(
							`${ENUM_FORM_SECTION.PRICING}.${ENUM_SUPPLEMENT_PRICING_FIELD.INVOICING}`,
							val as typeof ENUM_SUPPLEMENT_PRICING_INVOICING.INDIVIDUAL
						)
					}
					className="gap-4"
				>
