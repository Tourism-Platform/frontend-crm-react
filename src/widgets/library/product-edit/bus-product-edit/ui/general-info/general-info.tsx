...
import { ENUM_FORM_BUS_SECTION } from "@/entities/supplier";

import { BUS_PRODUCT_NAME_FIELD, type TSlotProps } from "../../model";
	...
	return (
		<div className="grid gap-4">
			<div className="grid gap-x-4 gap-y-1 grid-cols-2">
				{BUS_PRODUCT_NAME_FIELD.map(({ key, ...item }) => (
					<CustomField
						key={key}
						control={form.control}
						name={`${ENUM_FORM_BUS_SECTION.GENERAL}.${key}`}
						t={t}
						{...item}
					/>
				))}
