...
import { ENUM_TRAIN_PRODUCT_PRICING_FIELD } from "@/entities/supplier";

import type { TTrainProductPricingFormField } from "../types";

export const PRICING_PER_PERSON_PRICE_DETAILS_LIST: TTrainProductPricingFormField[] =
	[
		{
			...
			key: ENUM_TRAIN_PRODUCT_PRICING_FIELD.TOTAL_PRICE,
			fieldType: "input",
			type: "number"
		},
		{
			...
			key: ENUM_TRAIN_PRODUCT_PRICING_FIELD.CURRENCY,
			fieldType: "select",
