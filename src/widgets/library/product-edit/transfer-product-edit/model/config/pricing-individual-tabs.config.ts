import { ENUM_TRANSFER_PRODUCT_PRICING_TYPE } from "@/entities/supplier";

import type { ITransferProductIndividualPricingTab } from "../types";
...
export const PRICING_INDIVIDUAL_TABS_LIST: ITransferProductIndividualPricingTab[] =
	[
		{
			label: "form.pricing.pricing_type.tabs.flat_rate",
			type: ENUM_TRANSFER_PRODUCT_PRICING_TYPE.FLAT_RATE,
			priceDetailsList: PRICING_FLAT_RATE_PRICE_DETAILS_LIST
		},
		{
			label: "form.pricing.pricing_type.tabs.per_car",
			type: ENUM_TRANSFER_PRODUCT_PRICING_TYPE.PER_CAR
		},
		{
			label: "form.pricing.pricing_type.tabs.per_person",
			type: ENUM_TRANSFER_PRODUCT_PRICING_TYPE.PER_PERSON,
