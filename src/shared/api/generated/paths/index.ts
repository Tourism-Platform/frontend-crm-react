...
export { TOUR_EVENT_LIBRARY_PATHS } from "./tour-event-library.paths";
...
export { TRANSLATIONS_PATHS } from "./translations.paths";
export { OPERATOR_DOCUMENTS_PATHS } from "./operator-documents.paths";
export { OPERATOR_AGENCIES_PATHS } from "./operator-agencies.paths";
...
export { BOOKING_REVISION_PATHS } from "./booking-revision.paths";
...
export { BOOKING_RECONCILIATION_PATHS } from "./booking-reconciliation.paths";
export { BOOKING_VOUCHER_PATHS } from "./booking-voucher.paths";
export { INVOICE_PATHS } from "./invoice.paths";
export { LEDGER_PATHS } from "./ledger.paths";
export { PROFILE_INFO_PATHS } from "./profile-info.paths";
export { GEO_PATHS } from "./geo.paths";
export { AUDIT_PATHS } from "./audit.paths";
export { PERMISSIONS_PATHS } from "./permissions.paths";
export { PERMISSION_GROUPS_PATHS } from "./permission-groups.paths";
