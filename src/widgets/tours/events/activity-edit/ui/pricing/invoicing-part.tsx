...
import { ENUM_ACTIVITY_PRICING_FIELD } from "@/entities/tour";

import {
	ACTIVITY_PACKAGE_OPTIONS,
	ENUM_FORM_SECTION,
	type ISlotProps
} from "../../model";
		...
		<div className="grid gap-1">
			...
			<div className="grid grid-cols-3 mb-8">
				<CustomField
					...
					name={`${ENUM_FORM_SECTION.PRICING}.${ENUM_ACTIVITY_PRICING_FIELD.PACKAGE_TYPE}`}
					label="form.pricing.form.package.fields.package.label"
					fieldType="select"
					options={ACTIVITY_PACKAGE_OPTIONS}
					defaultValue={ACTIVITY_PACKAGE_OPTIONS[0]?.value}
					t={t}
				/>
			</div>
