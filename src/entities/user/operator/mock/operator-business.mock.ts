import {
	...
	type IOperatorBusinessInfoBackend
} from "../types";

export const OPERATOR_BUSINESS_MOCK: IOperatorBusinessInfoBackend = {
	avatarUrl:
	...
	legal: {
		...
		director: "John Doe",
		tin: "123456789",
		typeOfBusiness: ENUM_OPERATOR_BUSINESS_TYPES.TOUR_OPERATOR
	},
	address: {
