...
const PricingBase: FC<ISlotProps> = ({ form, onSubmit, isLoading }) => {
	...
	const invoicing = useWatch({
		...
		name: `${ENUM_FORM_SECTION.PRICING}.${ENUM_GUIDE_PRICING_FIELD.INVOICING}`
	});
	...
	return (
		<div className="grid gap-6">
			...
			<div className="grid gap-1">
				...
				<CustomOptionTabs
					value={invoicing ?? ENUM_GUIDE_PRICING_INVOICING.INDIVIDUAL}
					onValueChange={(val) =>
						form.setValue(
							`${ENUM_FORM_SECTION.PRICING}.${ENUM_GUIDE_PRICING_FIELD.INVOICING}`,
							val as typeof ENUM_GUIDE_PRICING_INVOICING.INDIVIDUAL
						)
					}
					className="gap-4"
				>
