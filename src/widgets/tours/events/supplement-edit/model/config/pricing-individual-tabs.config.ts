import { ENUM_SUPPLEMENT_PRICING_TYPE } from "@/entities/tour";

import type { ISupplementIndividualPricingTab } from "../types";
...
export const PRICING_INDIVIDUAL_TABS_LIST: ISupplementIndividualPricingTab[] = [
	{
		label: "form.pricing.pricing_type.tabs.flat_rate",
		type: ENUM_SUPPLEMENT_PRICING_TYPE.FLAT_RATE,
		priceDetailsList: PRICING_FLAT_RATE_PRICE_DETAILS_LIST
	},
	{
		label: "form.pricing.pricing_type.tabs.per_item",
		type: ENUM_SUPPLEMENT_PRICING_TYPE.PER_ITEM
	},
	{
		label: "form.pricing.pricing_type.tabs.per_person",
		type: ENUM_SUPPLEMENT_PRICING_TYPE.PER_PERSON,
