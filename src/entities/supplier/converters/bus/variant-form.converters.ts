...
export const emptyBusVariantForm = (): TBusVariantFormSchema => ({
	...
	[ENUM_FORM_BUS_VARIANT.BODY_TYPE]: null,
	[ENUM_FORM_BUS_VARIANT.PAX]: null,
...
export const mapBusVariantToForm = (
	...
	return {
		...
		[ENUM_FORM_BUS_VARIANT.BODY_TYPE]: variant.bodyType,
		[ENUM_FORM_BUS_VARIANT.PAX]: variant.pax,
...
export const mapBusVariantFormToWrite = (
	...
	return {
		...
		bodyType: values[ENUM_FORM_BUS_VARIANT.BODY_TYPE] ?? null,
		pax: values[ENUM_FORM_BUS_VARIANT.PAX] ?? null,
