...
import { TRAIN_FARES_SCHEMA } from "./train-fares.schema";
import { TRAIN_PRODUCT_PRICING_SCHEMA } from "./train-product-pricing.schema";
import { TRAIN_PRODUCT_GENERAL_SCHEMA } from "./train-product.schema";
