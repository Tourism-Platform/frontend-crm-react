...
export const ENUM_TRANSFER_PRODUCT_FLEET_CATEGORY_FIELD = {
	ID: "id",
	NAME: "name"
} as const;

export type ENUM_TRANSFER_PRODUCT_FLEET_CATEGORY_FIELD_TYPE =
	(typeof ENUM_TRANSFER_PRODUCT_FLEET_CATEGORY_FIELD)[keyof typeof ENUM_TRANSFER_PRODUCT_FLEET_CATEGORY_FIELD];

export interface ITransferProductFleetCategoryRow {
	[ENUM_TRANSFER_PRODUCT_FLEET_CATEGORY_FIELD.ID]?: string;
	[ENUM_TRANSFER_PRODUCT_FLEET_CATEGORY_FIELD.NAME]: string;
}
...
export interface ITransferProductCategoryPriceRow
	...
	[ENUM_TRANSFER_PRODUCT_CATEGORY_ROW_FIELD.CATEGORY_ID]: string;
	[ENUM_TRANSFER_PRODUCT_CATEGORY_ROW_FIELD.PRICE_ID]?: string;
