...
export const authApi = createApi({
	...
	tagTypes: [
		...
		ENUM_API_TAGS.OPERATOR.FINANCIAL_INFORMATION,
		ENUM_API_TAGS.OPERATOR.CURRENCY_RATES,
		ENUM_API_TAGS.OPERATOR.STAFF_INFORMATION,
		ENUM_API_TAGS.OPERATOR.PAYMENT_ROUTES,
		ENUM_API_TAGS.OPERATOR.AGENCIES,
		ENUM_API_TAGS.TOURS_OPTIONS,
		ENUM_API_TAGS.TOURS_PRICING_SUMMARY,
		ENUM_API_TAGS.TOURS_PACKAGES,
		ENUM_API_TAGS.LANDING_IMAGES,
