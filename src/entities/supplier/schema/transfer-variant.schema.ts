...
import { ENUM_FORM_TRANSFER_VARIANT } from "../types/transfer/variant-form.types";

const msg = i18nKey<TTransferProductEditPageKeys>();

const TRANSFER_VARIANT_FEE_SCHEMA = z.object({
...
export const TRANSFER_VARIANT_FORM_SCHEMA = z.object({
	...
	[ENUM_FORM_TRANSFER_VARIANT.BODY_TYPE]: z
