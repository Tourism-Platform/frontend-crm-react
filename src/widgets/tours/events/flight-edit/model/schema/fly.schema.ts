...
export const FLY_SEGMENT_SCHEMA = z.object({
	[ENUM_FORM_FLIGHT.AIRLINE_CODE]: z
		...
		.min(1, {
			message: msg(
				"general.flights.form.fly.fields.airline_code.errors.required"
			)
		})
		.min(2, {
			message: msg(
				"general.flights.form.fly.fields.airline_code.errors.min"
			)
		})
		.max(10, {
			message: msg(
				"general.flights.form.fly.fields.airline_code.errors.max"
			)
		}),
	...
	[ENUM_FORM_FLIGHT.FLIGHT_NUMBER]: z
		...
		.min(1, {
			message: msg(
				"general.flights.form.fly.fields.flight_number.errors.required"
			)
		})
		.min(1, {
			message: msg(
	...
	[ENUM_FORM_FLIGHT.DEPARTURE_AIRPORT_CODE]: z
		...
		.min(1, {
			message: msg(
				"general.flights.form.fly.fields.departure_airport_code.errors.required"
			)
		})
		.length(3, {
			message: msg(
	...
	[ENUM_FORM_FLIGHT.ARRIVAL_AIRPORT_CODE]: z
		...
		.min(1, {
			message: msg(
				"general.flights.form.fly.fields.arrival_airport_code.errors.required"
			)
		})
		.length(3, {
			message: msg(
