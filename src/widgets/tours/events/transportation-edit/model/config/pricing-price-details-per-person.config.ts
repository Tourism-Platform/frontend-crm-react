...
export const PRICING_PER_PERSON_PRICE_DETAILS_LIST: TTransportationPricingFormField[] =
	[
		{
			...
			key: ENUM_TRANSPORTATION_PRICING_FIELD.TOTAL_PRICE,
			fieldType: "input",
			type: "number"
		},
		{
			...
			key: ENUM_TRANSPORTATION_PRICING_FIELD.TAXES,
			fieldType: "input",
			type: "number"
		},
		{
			...
			key: ENUM_TRANSPORTATION_PRICING_FIELD.CURRENCY,
			fieldType: "select",
